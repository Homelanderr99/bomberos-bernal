                ...
                <div className='relative w-full flex flex-col items-center min-h-[100dvh]'>
                    ...
                    <div className='container mx-auto flex flex-col items-center justify-start relative z-10'>
                        <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
                            ...
                            >
                                <motion.h2
                                    className='text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter transition-none text-transparent bg-clip-text bg-gradient-to-b from-yellow-300 via-orange-500 to-red-600 drop-shadow-[0_0_25px_rgba(239,68,68,0.6)]'
                                    style={{ transform: `translateX(-${textTranslateX}vw)` }}
                                >
                                    {firstWord}
                                </motion.h2>
                                <motion.h2
                                    className='text-5xl md:text-7xl lg:text-8xl font-black uppercase tracking-tighter text-center transition-none text-transparent bg-clip-text bg-gradient-to-b from-yellow-300 via-orange-500 to-red-600 drop-shadow-[0_0_25px_rgba(239,68,68,0.6)]'
                                    style={{ transform: `translateX(${textTranslateX}vw)` }}
                                >
                                    {restOfTitle}
                                </motion.h2>
